    ...
    return (
        <div className="min-h-screen text-white flex flex-col" style={{ background: "linear-gradient(180deg, #1a0a2e 0%, #2d1b4e 30%, #1a0a2e 70%, #0a0612 100%)" }}>
            ...
            <div className="max-w-4xl w-full mx-auto px-6 py-8 pb-24 space-y-8">
                ...
                {/* Reviews Section — song/album reviews that mention this artist */}
                <div className="p-6 rounded-2xl bg-[#221c2f] border border-gray-800">
                    <BaseHeading headingLevel="h2" fontSize="normal" fontWeight={600} className="mb-6">Reviews</BaseHeading>
                    {reviews.length > 0 ? (
                        ...
                        <BaseText textColor="#6b7280">No reviews yet. Reviews mentioning you will appear here.</BaseText>
                    )}
                </div>
            </div>
        </div>
